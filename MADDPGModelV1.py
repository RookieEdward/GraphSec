...
class Agent:
    def __init__(self, name, num_obs, num_act, num_agent, num_node):
        ...
        def get_actor():
            ...
            out = layers.Dense(100, activation="selu")(inputs)
            out = layers.Dropout(0.2)(out)
            out = layers.Dense(100, activation="selu", kernel_initializer=last_init)(out)
            out = layers.Dropout(0.2)(out)
            out = layers.Dense(100, activation="selu", kernel_initializer=last_init)(out)
            out = layers.Dropout(0.2)(out)
            out = layers.Dense(100, activation="selu", kernel_initializer=last_init)(out)
        ...
        def get_critic():
            ...
            state_output = layers.Dense(100, activation="selu")(state_input)
            state_output = layers.Dense(100, activation="selu")(state_output)
            ...
            action_out = layers.Dense(100, activation="selu")(action_input)
            # Both are passed through seperate layer before concatenating
            concat = layers.Concatenate()([state_output, action_out])

            action_out = layers.Dense(100, activation="selu")(concat)
            action_out = layers.Dense(100, activation="selu")(action_out)
            action_out = layers.Dense(100, activation="selu")(action_out)
